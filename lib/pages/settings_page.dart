...
class _SettingsPageState extends State<SettingsPage> {
            ...
            children: [
              const SizedBox(
                ...
                child: CircularProgressIndicator(
                  strokeWidth: 3,
                  valueColor: AlwaysStoppedAnimation<Color>(NeoBrutalismTheme.onSurface),
                ),
              ),
            ...
            child: NeoBrutalismCard(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.warning, color: NeoBrutalismTheme.error, size: 28),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // Mengubah background dari transparent ke solid off-white agar grid background terlihat sempurna (tidak hitam)
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                // 1. Standalone Header Card (Sesuai Stitch settings.html)
                NeoBrutalismCard(
                  backgroundColor:
                ...
                // 2. Card Gabungan: Profile & Account (Edit Nama + Pilih Avatar, Sesuai Stitch)
                NeoBrutalismCard(
                  backgroundColor: Colors.white,
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      // Header Section Profile & Account dengan Icon Person
                      Row(
                        children: [
                          const Icon(
                            Icons.person,
                      ...
                      // Edit Nama (Display Name) dengan Suffix Icon Edit
                      NeoTextField(
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            // Dotted/Mock Custom Avatar Button (Sesuai Stitch settings.html)
                            GestureDetector(
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                      ...
                      NeoBrutalismButton(
                        backgroundColor:
                            NeoBrutalismTheme.tertiaryContainer, // Neon Green
                ...
                // 3. Card: NOTIFICATIONS (Sesuai dengan gaya Neo-Brutalist Stitch)
                NeoBrutalismCard(
                  backgroundColor: Colors.white,
                  padding: const EdgeInsets.all(18.0),
                  child: Column(
                    ...
                    children: [
                      ...
                      // If enabled, show Offset and Daily Digest settings
                ...
                // 4. Card: Data Management (Sesuai Stitch settings.html)
                NeoBrutalismCard(
                  backgroundColor: NeoBrutalismTheme
                      .surfaceContainerHigh, // Light grey container background
                  padding: const EdgeInsets.all(18.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      // Header Section Data Management dengan Icon Database/Storage
                      Row(
                        children: [
                          const Icon(
                            Icons.storage,
